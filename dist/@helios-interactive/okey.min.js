...
!function(exports, global) {
    ...
    var handleKeydownEvents = function(e) {
        ...
        e.target.classList.remove("active"), this.keyHoldTimeout && window.clearTimeout(this.keyHoldTimeout), 
        this.keyHoldInterval && window.clearInterval(this.keyHoldInterval);
    };
