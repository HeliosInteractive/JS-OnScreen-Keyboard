...
!function(exports, global) {
                ...
                if ("backspace" != e.key) {
                    if (!(this.value.length >= this.maxLength && -1 != this.maxLength)) {
                        ...
                        if (selectionSupported) {
                            ...
                            this.value = splice(this.value, el.selectionStart, el.selectionEnd - el.selectionStart, e.key || String.fromCharCode(e.keyCode)), 
    ...
    function Keyboard(inputs, holder) {
        ...
        this.show = function(layout) {
            ...
            self.layout && layout === self.layout && this.active || (this.active = !0, self.layout = layout, 
            this.keyboardEl.innerHTML = "", this.keyboardEl.classList.remove("keyboard-container-hidden"), 
            global.Keyboard.layout[self.layout].forEach(foreachLayout), holder.appendChild(self.keyboardEl));
        }, this.hide = function() {
