...
!function(exports, global) {
    ...
    function Keyboard(inputs, holder) {
        ...
        this.keyboardEl.addEventListener("touchend", handleKeyupEvents.bind(this)), this.show = function(layout) {
            ...
            if (clearKeyHoldTimers(), !global.Keyboard.layout[layout]) throw new Error("keyboard initiation: Missing layout: " + layout);
            ...
            self.active = !1, dispatchKeyboardCloseEvent(), setTimeout(function() {
    ...
    var handleKeydownEvents = function(e) {
        ...
        e.target.classList.remove("active"), clearKeyHoldTimers();
    }, clearKeyHoldTimers = function() {
        window.keyHoldTimeout && window.clearTimeout(window.keyHoldTimeout), window.keyHoldInterval && window.clearInterval(window.keyHoldInterval);
    };
